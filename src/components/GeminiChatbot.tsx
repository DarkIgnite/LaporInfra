...
> = {
  general: {
    ...
    suggestedPrompts: [
      'Bagaimana cara memfoto jalan berlubang agar mudah diverifikasi dinas?',
      'Berapa lama estimasi waktu penanganan laporan jalan rusak?',
      'Apa arti status laporan "Baru", "Diproses", dan "Selesai"?',
      'Bagaimana peran partisipasi warga dalam mendukung target SDG 9?',
    ],
  },
  complex: {
...
${ROLE_PRESETS[newRole].description}`,
  ...
  return (
    <div
      ...
      className={`flex flex-col bg-white border border-stone-200/90 shadow-2xl rounded-2xl overflow-hidden ${
        floating
          ? 'fixed bottom-20 right-4 sm:right-6 w-[94vw] sm:w-[460px] h-[640px] max-h-[82vh] z-50 animate-in fade-in zoom-in-95 duration-200'
          : 'w-full h-full min-h-[580px]'
      }`}
    >
      {/* 1. Header with Role Mode Selector */}
          ...
          return (
            ...
            >
              ...
              >
                ...
                {/* Google Maps Grounding Citations & Direct Links (if returned) */}
      ...
      {/* 4. Maps Grounding & Geolocation Controls */}
